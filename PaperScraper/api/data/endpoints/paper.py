...
from PaperScraper.api.data.serializers import paper
from PaperScraper.api.data.operations import create_paper, update_paper, delete_paper
from PaperScraper.api.restplus import api

log = logging.getLogger(__name__)

ns = api.namespace('data/paper', description='Interact with MongoDB Papers Instance.')
